...
<div class="col-md-2 text-center">
    <a href="rating-users.php"><button class="btn btn-success">Baholash</button></a>
</div>
</div>
                ...
                foreach($data as $id => $arr){
                    ...
                    echo "
                        ...
                        <tr>
                            ...
                            <td class='td'>{$arr['user_rate']}</td>
                            <td class='td'>{$arr['user_rating']}</td>
                            <td class='td'>
                                <a href='delete-rate.php?id={$id}' class='btn btn-danger'>
