...
if($user_id != ""){
    $data = $db->retrieve("admin/{$got_user_id}");
...
<form action="update-admin-action.php" method="post" class="container shadow form-group p-3" style="width:80%;margin:0 auto;margin-top:0px;">
    <h4 class="text-center" style="color:#eb8153;">Adminni tahrirlash</h4>
    ...
    <strong>Parol</strong>
    <input class="form-control mb-2" type="password" name="password" value="<?php echo $password; ?>" placeholder="Parol" required>
