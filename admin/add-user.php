...
<form action="add-user-action.php" method="post" autocomplete="false" class="container shadow form-group p-3" style="width:80%;margin:0 auto;margin-top:0px;">
    ...
    <input class="btn btn-success" type="submit" name="add-user" value="Qo'shish">
    <input class="btn btn-success" type="submit" name="add-user-continue" value="Qo'shish va Davom etish">
</form>
