...
$data = $db->retrieve("rate_ai_users");
    ...
    <?php
            ...
            if($data != null){
                foreach($data as $id => $arr){
                    ...
                    $data2 = $db->retrieve("ai_files/{$mt_id}");
                    $data2 = json_decode($data2, 1);
                    $mt_name = $data2['ai_name'];
                    echo "
                        ...
                        <tr>
                            ...
                            <td class='td'>{$arr['ai_user_rate']}</td>
                            <td class='td'>
                                <a href='delete-ai-rate.php?id={$id}' class='btn btn-danger'>
