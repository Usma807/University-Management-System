...
<div class="row p-2">
    ...
    <div class="col-md-2 text-center">
        <a href="add-admin.php"><button class="btn btn-success">Yangi qo'shish</button></a>
    </div>
</div>
            ...
            foreach($data as $id => $arr){
                ...
                echo "
                    ...
                    <tr>
                        ...
                        <td>{$arr['password']}</td>
                        <td>
                            <a href='update-admin.php?id={$id}' class='btn btn-warning text-light'>
                        ...
                        <td>
                            <a href='delete-admin.php?id={$id}' class='btn btn-danger'>
